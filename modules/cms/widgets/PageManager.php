 ...
 */
class PageManager extends WidgetBase
{
    ...
    {
        $this->addJs('js/pagemanager.js', 'global');
    }
    ...
    public function onLoadPopup()
    {
        ...
        return $this->makePartial('pagemanager_form');
    }
    ...
    {
        return (bool) post('pagemanager_title');
    }
    ...
    {
        return (bool) post('pagemanager_single');
    }
}
